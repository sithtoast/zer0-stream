defmodule ExICE.Priv.ICEAgent do
  ...
  defp get_or_create_local_cand(%__MODULE__{} = ice_agent, xor_addr, conn_check_pair) do
    ...
    cond do
      # A successful check sent through TURN must keep the relay candidate and
      # its client. NAT/hairpinning can make XOR-MAPPED-ADDRESS differ from the
      # allocation. Promoting it to Prflx both looks up an unregistered public
      # base address and loses the TURN transport needed to reach this peer.
      conn_check_local_cand.base.type == :relay ->
